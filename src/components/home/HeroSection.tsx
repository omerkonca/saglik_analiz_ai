    ...
    <div className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold text-gray-900 tracking-tight mb-8 animate-fade-in">
            Sağlığınızı{' '}
            <span className="text-indigo-600">Yapay Zeka</span>{' '}
            ile Analiz Edin
          </h1>
          <p className="max-w-2xl mx-auto text-xl text-gray-500 mb-10 animate-slide-up">
